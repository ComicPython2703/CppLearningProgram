...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ms="urn:microsoft-performance" exclude-result-prefixes="msxsl" version="1.0">
	...
	<xsl:variable name="images">
		...
		<!-- root cause states -->
		<String id="fixed">已解决</String>
		<String id="notfixed">未修复</String>
		<String id="detected">检测到</String>
		<!-- details -->
		<String id="info">信息</String>
		<String id="warning">警告</String>
		<String id="error">错误</String>
		<!-- expand and print buttons -->
		<String id="expand">展开</String>
		<String id="print">打印</String>
	</xsl:variable>
	<xsl:variable name="font">
		<Font id="font">Microsoft YaHei UI</Font>
	</xsl:variable>
...
function key_folder(d, state)
{
  if (window.event.keyCode == 13) {
    ...
    event.returnValue = false;
						...
						<div class="page">
							<xsl:variable name="strings">
								<String id="Found">找到问题</String>
								<String id="Checked">检测到的潜在问题</String>
								<String id="Publisher">发布者详细信息</String>
								<String id="Detection">检测详细信息</String>
	...
	<xsl:template name="RootCauseStatus">
		<xsl:variable name="strings">
			<String id="Fixed">已解决</String>
			<String id="Not Detected">问题不存在</String>
			<String id="Not Fixed">未修复</String>
			<String id="Detected">检测到</String>
		</xsl:variable>
		<div>
			<xsl:if test="Data[@id='Status'] = 'Not Detected'">
	...
	<xsl:template name="RootCauseEmpty">
		<xsl:variable name="strings">
			<String id="Empty">未检测到任何问题</String>
		</xsl:variable>
	...
	<xsl:template name="ResolutionStatus">
		<xsl:variable name="strings">
			<String id="Not Run">未运行</String>
			<String id="Succeeded">已完成</String>
			<String id="Failed">已失败</String>
			<String id="Informational">信息</String>
	...
	<xsl:template match="InputArguments[Data]|OutputArguments[Data[@id !='Result']]">
		<xsl:variable name="strings">
			<String id="InputArguments">输入参数</String>
			<String id="OutputArguments">输出参数</String>
		</xsl:variable>
	...
	<xsl:template match="Object[@Type='System.Diagnostics.Eventing.Reader.EventLogRecord']">
		<xsl:variable name="strings">
			<String id="LevelDisplayName">等级</String>
			<String id="LogName">日志</String>
			<String id="TimeCreated">日期</String>
			<String id="Message">邮件</String>
		</xsl:variable>
	...
	<xsl:template match="Data[@id='RunningTime']">
		<xsl:variable name="strings">
			<String id="millisecond">毫秒</String>
		</xsl:variable>
		<tr>
			<th><xsl:value-of select="@name"/>:</th>
			<td>
	...
	<xsl:template match="ComputerInformation">
		<xsl:variable name="strings">
			<String id="Computer">计算机名</String>
			<String id="Collection">收集信息</String>
		</xsl:variable>
